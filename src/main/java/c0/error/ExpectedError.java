...
public class ExpectedError extends CompileError {
     ...
     * @param token
     */
    public ExpectedError(TokenType expectedTokenType, Token token) {
     ...
     * @param token
     */
    public ExpectedError(List<TokenType> expectedTokenType, Token token) {
